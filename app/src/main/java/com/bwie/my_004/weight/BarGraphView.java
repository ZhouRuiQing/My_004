...
public class BarGraphView extends View {
    ...
    public BarGraphView(Context context, @Nullable AttributeSet attrs) {
     ...
     /*   TypedArray mArray = context.obtainStyledAttributes(attrs, R.styleable.BarGraphView);
        title = mArray.getString(R.styleable.ConstraintSet_barrierDirection);
     ...
     * @param pideSize 刻度线数量
     */
    public void setAxisX(float maxValue, int pideSize) {
        maxAxisValueX = maxValue;
        axisDivideSizeX = pideSize;
    }
     ...
     * @param pideSize 刻度线数量
     */
    public void setAxisY(float maxValue, int pideSize) {
        maxAxisValueY = maxValue;
        axisDivideSizeY = pideSize;
    }
